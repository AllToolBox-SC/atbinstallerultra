...
import { onKeyPress, onPointer } from "../InputModality";
...
export default function HomeScreen({ navigation }) {
  ...
  return (
    <View style={styles.container} onKeyDown={onKeyPress} onPointerDown={onPointer} focusable={false} accessible={false}>
        <Appbar.Header>
